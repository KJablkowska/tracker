...
import kotlinx.android.synthetic.main.activity_heart_bpm.*
...
class HeartBPM : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_heart_bpm)
    }
        ...
        private fun startWithPermissionCheck() {
            ...
            val bpmUpdates = HeartRateOmeter()
                ...
                .subscribe({
                    ...
                    val bpm = it.copy(c.get(0, 0).toInt())
